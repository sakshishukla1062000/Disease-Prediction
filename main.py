...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="white", bg="grey")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="A Project by Group 9", fg="red", bg="grey")
...
lrLb.grid(row=15, column=0, pady=20,sticky=W)
lrLb.config(font=("Aharoni", 15))
...
NameEn = Entry(root, textvariable=Name,width=20)
